...
#$base = 'output.pcap_';
#$algo = 'claffy_tcp_';
#$date = '20110918-095205.csv';
#my $file = 'output.pcap_claffy_unlimited_20110918-095205.csv';
#   $file = 'output.pcap_claffy_tcp_20110918-095205.csv';
#$file = 'test.csv';
#buildstore('output.pcap_claffy_unlimited_20110918-095205.csv');
#buildstore('output.pcap_claffy_tcp_20110918-095205.csv');
